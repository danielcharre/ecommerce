    ...
    class User extends model {
        ...
        public static function getForgot($email) {
            ...
            if(count($results) === 0) {
                ...
                $results2 = $sql = $sql->select("CALL sp_userspasswordsrecoveries_create(:iduser, :desip)", [
                    ":iduser"=>$data["iduser"],
                ...
                if(count($results2) === 0) {
                    ...
                    $mailer = new Mailer($data["desemail"], $data["desperson"], "Redifinir senha da puta que pariu", "forgot", [
                        "name"=>$data["desperson"],
                        "link"=>$link
                    ]);
